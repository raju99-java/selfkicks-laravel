...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta charset="UTF-8">
        <title>{{env('APP_NAME', 'Self Kicks')}} :: Admin</title>
        ...
        <link rel="stylesheet" href="{{ URL::asset('public/backend/custom/zebra_datepicker/css/default/zebra_datepicker.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/backend/custom/zebra_datepicker/css/default/zebra_datepicker.min.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/backend/custom/zebra_datepicker/css/default/zebra_datepicker.scss')}}">
        @yield('page_css')
    </head>
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <script src="{{ URL::asset('public/backend/custom/zebra_datepicker/zebra_datepicker.min.js')}}"></script>
        <script src="{{ URL::asset('public/backend/custom/zebra_datepicker/zebra_datepicker.src.js')}}"></script>
