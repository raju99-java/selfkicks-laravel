                ...
                <div class="tab-content">
                    ...
                    foreach ($modules as $module_name => $module) {
                        ...
                        <div class="tab-pane <?php echo $class; ?>" id="tab_s_<?php echo $count; ?>">
                            <form method="post" action="{{Route('settings')}}" id="save_<?php echo $module_name ?>" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="box-body">
                                    <?php
                                    $html = '';
...
//                                                                $html .="<input style='display:none;' type=\"checkbox\" checked name=\"settings[$settings->slug][]\" value=\"0\">";
                                                ...
                                                case 'file':
                                                    $photo = $settings->value ? URL::asset('public/uploads/ad/' . $settings->value) : URL::asset('public/backend/no-image.png');
                                                    $html .= "<div class=\"input type-{$settings->type}\">";
                                                    $html .= "<input type=\"file\" class=\"form-control\" id=\"{$settings->slug}\" name=\"settings[{$settings->slug}]\"  required>";
    
                                                    $html .= "<div class='view-image'><div class='col-md-10'>";
                                                    $html .= "<a href=\"{$photo}\"  target='_blank'><button type='button' class='btn green'><i class='fa fa-eye'></i> View</button></a> ";
                                                    $html .= "</div></div>";
                                                    $html .= $show_slug;
                                                    $html .= "</div>";
                                                    break;
