...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('premium-member')}}">Premium Member</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('premium-member-edit',['id'=>$id])}}" class="form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    {{csrf_field()}}
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('premium-member')}}" class="btn btn-primary">Cancel</a>
