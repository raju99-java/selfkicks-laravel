        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Add Video</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('video-add')}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('video_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Video Name" name="video_name" value="{{ (old('video_name')!="") ? old('video_name') : ''}}"/>
                        ...
                        <div class="form-group {{ $errors->has('embeded_video') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Embeded Video" name="embeded_video"  id="body">{{ (old('embeded_video')!="") ? old('embeded_video') : '' }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('features') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Features" name="features" value="{{ (old('features')!="") ? old('features') : ''}}"/>
                        ...
                        <div class="form-group {{ $errors->has('actors') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Actors" name="actors" value="{{ (old('actors')!="") ? old('actors') : ''}}"/>
                        ...
                        <div class="form-group {{ $errors->has('directors') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Directors" name="directors" value="{{ (old('directors')!="") ? old('directors') : ''}}"/>
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control ckeditor" placeholder="Description" name="description"  id="body">{{ (old('description')!="") ? old('description') : '' }}</textarea>
                            ...
                            <div class="col-md-10">
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="latest" value="1"> Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="latest" value="0"> No
                                    </label>
                        ...
                        <div class="form-group {{ $errors->has('popular') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <div class="radio-list">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="popular" value="0"> No
                                    </label>
