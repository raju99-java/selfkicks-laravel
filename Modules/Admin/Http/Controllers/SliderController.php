...
class SliderController extends AdminController {
    ...
    public function create() {
        $data = [];
        $data['videos'] = Video::where('status','=','1')->where('prime','=','0')->orderBy('id','desc')->get();
    ...
    public function edit($id) {
        ...
        $videos = Video::where('status','=','1')->where('prime','=','0')->orderBy('id','desc')->get();
        return view('admin::slider.edit', compact('data','videos'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        $validator = Validator::make($request->all(), [
                    ...
                    'details_text' => 'required',
                    'status' => 'required',
                    'photo' => 'nullable|mimes:jpeg,webp,jpg,png,svg',
                        ]
        );
        $validator->after(function($validator) use($request) {
